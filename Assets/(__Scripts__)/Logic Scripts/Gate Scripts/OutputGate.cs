...
public class OutputGate : MonoBehaviour, IBorderable, IColorable, IItemable, ILogicHandler
{
    // Unity GameObjects: //////////////////////////////////////////////////////
    // Unity Components: ///////////////////////////////////////////////////////
    [SerializeField] SpriteRenderer _topSprite_SpriteRenderer;
    ...
    public void HandleLogic()
    {
        ...
        _currentLogicState = inputPin.LogicState;
        LogicColor = inputPin.LogicColor;      

        if (_currentLogicState == LogicState.On)
        {
            _topSprite_SpriteRenderer.color = LogicColor.OnColor;
        }
        else if (_currentLogicState == LogicState.Off)
        {
            _topSprite_SpriteRenderer.color = LogicColor.OffColor;
        }
        else
        {
            _topSprite_SpriteRenderer.color = Color.white;
        }
